...
public class LinearMotionModel : MotionModel
{
    public override Vector3 UpdatePosition(float deltaTime)
    {
        ...
        TrySetParam(ParamName.deltaPathTraveled, deltaPosition.magnitude);
        return newPosition;
    }
    ...
    public override Vector3 CalculatePosition(float time)
    {
        ...
        Vector3 currentpos = (Vector3)GetParam(ParamName.startingPosition);
        Vector3 newPosition = deltaPosition + currentpos;
    ...
    public override List<TopicField> GetRequiredParams()
    {
        return new List<TopicField>
        {
           ...
           new TopicField(ParamName.startingPosition, FieldType.Vector3,false),
